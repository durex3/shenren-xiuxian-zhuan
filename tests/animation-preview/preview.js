...
class PreviewScene extends Phaser.Scene {
  preload() {
    ...
    const files = new Set([...Object.values(actors).flatMap(actions => Object.values(actions).flat()), ...Object.values(effectFiles), ...webBindFrames, ...spiderDeathEffectFrames]);
  ...
  update(_time, delta) {
    ...
    this.fx.setAlpha(1).setOrigin(0.5).setBlendMode(Phaser.BlendModes.NORMAL);
    if(attacking) {
